...
<div class="container my-4">
    <?PHP if (count($items)) { ?>
        <form action="admin/actions/actualizar_prod_acc.php" method="POST">
            <table class="table">
                ...
                <tbody>
                    <?PHP foreach ($items as $key => $item) { ?>
                        <tr>
                            ...
                            <td class="text-end align-middle">
                                <a href="admin/actions/quitar_prod_acc.php?id=<?= $key ?>" class="btn btn-sm btn-danger">Eliminar</a>
                            </td>
                        </tr>
                    <?PHP } ?>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <a href="index.php?sec=finalizar_compra" role="button" class="btn btn-primary">Finalizar Compra</a>
            </div>
    ...
    <?PHP } else { ?>
        <div class="d-flex">
            <div class="m-auto text center">
                ...
                <h3 class="text-center mb-5 text-black">Su carrito esta vacio</h3>
