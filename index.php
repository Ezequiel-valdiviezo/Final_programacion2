...
$secciones_validas = [
    ...
    "finalizar_compra" => [
        "titulo" => "finalizar_compra",
        "restringido" => TRUE
    ],
    "panel_usuario" => [
        "titulo" => "panel_usuario",
        "restringido" => TRUE
    ],
    "test" => [
        "titulo" => "test",
    ...
    <nav class="navbar navbar-expand-lg bg-white sticky-top">
                ...
                <div class="collapse navbar-collapse text-center" id="navbarNav">
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link lineaBaja" href="index.php?sec=panel_usuario">Panel usuario</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link bg-secondary text-light rounded <?= $userData ? "d-none" : "" ?> mb-2" href="index.php?sec=login">Login</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link bg-secondary text-light rounded <?= $userData ? "" : "d-none" ?> mb-2" href="admin/actions/auth_logout.php?ref=front">Logout</a>
                        </li>
                    </ul>
                </div>
                </div>
